			...
			public void actionPerformed(ActionEvent arg0){
				...
				class Edit_AddObject{
					...
					public Connection getConnection1(){
						...
						try{
							con1 = DriverManager.getConnection("jdbc:mysql://localhost:3306/test_db?useSSL=true","root","123456789");
							jta.append("数据库连接成功\n");
            ...
            public void actionPerformed(ActionEvent arg0){
            	...
            	class Edit_DeleteObject{
            		...
            		public Connection getConnection2(){
            			...
            			try{
            				con2 = DriverManager.getConnection("jdbc:mysql://localhost:3306/test_db?useSSL=true","root","123456789");
            				jta.append("数据库连接成功\n");
            			}catch(SQLException e){
            				jta.append("数据库连接失败\n");
            			}
            ...
            public void actionPerformed(ActionEvent arg0){
            	...
            	class Edit_ShowList{
            		...
            		public Connection getConnection3(){
            			...
            			try{
            				con3 = DriverManager.getConnection("jdbc:mysql://localhost:3306/test_db?useSSL=true","root","123456789");
            				jta.append("数据库连接成功\n");
            			}catch(SQLException e){
            				jta.append("数据库连接失败\n");
            			}
            ...
            public void actionPerformed(ActionEvent arg0){
            	...
            	class Edit_Search{
            		...
            		public Connection getConnection4(){
            			...
            			try{
            				con4 = DriverManager.getConnection("jdbc:mysql://localhost:3306/test_db?useSSL=true","root","123456789");
            				jta.append("数据库连接成功\n");
            			}catch(SQLException e){
            				jta.append("数据库连接失败\n");
            			}
